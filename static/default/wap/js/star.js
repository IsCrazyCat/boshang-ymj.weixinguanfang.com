    ...
    $.fn.raty = function(settings) {
        ...
        if (!options.readOnly) {
            if (options.showCancel) {
                ...
                $(document)
                .on('mouseenter','#' + containerId + ' img.button-cancel', function() {
                    $(this).attr('src', path + cancelOn);
                    $('img.' + containerId).attr('src', path + starOff);
                })
                .on('mouseleave','#' + containerId + ' img.button-cancel', function() {
                    $(this).attr('src', path + cancelOff);
                    $('img.' + containerId).trigger('mouseout');
                })
                .on('click','#' + containerId + ' img.button-cancel', function() {
            ...
            $(document)
            .on('mouseenter','img.' + containerId, function() {
            ...
            .on('click','img.' + containerId, function() {
