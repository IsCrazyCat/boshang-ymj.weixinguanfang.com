		...
		<div class="tableBox">
			...
			<tr>
				...
				<td class="rgTdBt">
					...
					<code>注意这个不是网站的Title，一般建议是网站的品牌名，需要提现自动付款联系</code>
				</td>
			</tr>
			<tr>
				<td class="lfTdBt">
				...
				<td class="rgTdBt">
					...
					<code>例如：http://www.baocms.cn 如果你在二级目录下面就需要带上二级目录</code>
				</td>
			</tr>
			<tr>
				<td class="lfTdBt">
				...
				<td class="rgTdBt">
					...
					<code>例如：baocms.cn 用于分站二级域名，这里的域名一定要泛解析，否则失效！</code>
				</td>
			</tr>
			<tr>
				<td class="lfTdBt">
				...
				<td class="rgTdBt">
					...
					<code>例如：http://www.baocms.cn 一般情况下是和站点网址一样，如果做了CDN加速一般就可能是其他的域名</code>
				</td>
			</tr>
<!--			<tr>-->
<!--				<td class="lfTdBt">-->
...
<!--                    <code>这里直接是影响商家中心用户自动确认收货的时间，请认真填写，一般外卖3小时，商城7天</code>-->
				</td>
			</tr>
<!--			<tr>-->
<!--				<td class="lfTdBt">-->
